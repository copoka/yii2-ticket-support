...
<div itemscope itemtype="http://schema.org/EmailMessage">
    <div itemprop="potentialAction" itemscope itemtype="http://schema.org/ViewAction">
        ...
        <meta itemprop="name" content="<?= \copoka\support\Module::t('support', 'View Ticket') ?>"/>
    </div>
    <meta itemprop="description"
          content="<?= \copoka\support\Module::t('support', 'You\'ve received a ticket (#{ID}) from {APP}',
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <?= \copoka\support\Module::t('support', 'Greetings from {APP},',
                                            ['APP' => Yii::$app->name]) ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <?= \copoka\support\Module::t('support',
                                ...
                                <tr>
                                    <td class="content-block">
                                        <?= \copoka\support\Module::t('support', 'Ticket #{ID}',
                                            ['ID' => $model->id]) ?>
                                        <br>
                                        <?= \copoka\support\Module::t('support', 'Subject: {TITLE}',
                                            ['TITLE' => $model->title]) ?>
                                        <br>
                                ...
                                <tr>
                                    <td class="content-block aligncenter" colspan="2">
                                        <a href="<?= $model->getUrl(true) ?>"
                                           class="btn-primary"><?= \copoka\support\Module::t('support',
                                                'View Ticket') ?></a>
                                    </td>
                                </tr>
